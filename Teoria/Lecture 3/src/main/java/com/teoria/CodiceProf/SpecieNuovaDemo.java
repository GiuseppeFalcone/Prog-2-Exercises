...
public class SpecieNuovaDemo { //classe eseguibile pubblica
  ...
  /** Questo metodo ferma l’esecuzione del programma e aspetta un a capo per continuare. E' statico, quindi non viene inviato a un oggetto, ma chiamato scrivendo: pause(); */
