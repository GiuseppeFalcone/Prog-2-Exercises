package com.teoria.DieHardImproved;
...
public class DieHardImp {
    ...
    public static void travasa(BottigliaImp a, BottigliaImp b) {
    ...
    public static void descrizione(String m, BottigliaImp b3, BottigliaImp b5) {
        System.out.println(m + "\n" + b3 + "\n" + b5);
    }

    public static void main(String[] args) {
        //Una soluzione all'indovinello con le tre operazioni consentite
        BottigliaImp b3 = new BottigliaImp(3), b5 = new BottigliaImp(5);
