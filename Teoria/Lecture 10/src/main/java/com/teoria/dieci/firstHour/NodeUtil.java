...
// int max = Math.max(num1, num2)
     ...
     */
    public static boolean member(Node node, int value) {
        while (node != null) {
     ...
     *
     * @param p la lista
     * @return ritrna la lista in formato stringa
     */
...
//        System.out.println("Ora con Contatti");
//        System.out.println("---------------------");
//
//        //aggiungo i nodi di q={10,20,30,40} a sinistra, dunque parto da 40
//        NodeContatto q2 = new NodeContatto(new Contatto("40", "40@cc.com"), null);
//        q2 = new NodeContatto(new Contatto("30", "30@cc.com"), q2);
//        q2 = new NodeContatto(new Contatto("20", "20@cc.com"), q2);
//        q2 = new NodeContatto(new Contatto("10", "10@cc.com"), q2);
//
//        System.out.println("Lista q2:");
//        scriviOutput(q2);
//        System.out.println("---------------------");

        //aggiungo i nodi di p={10,20,30,40,30,20,10} a sinistra
//        NodeContatto p2 = new NodeContatto(new Contatto("10", "40@cc.com"), null);
//        p2 = new NodeContatto(new Contatto("20", "30@cc.com"), p2);
//        p2 = new NodeContatto(new Contatto("30", "20@cc.com"), p2);
//        p2 = new NodeContatto(new Contatto("40", "10@cc.com"), p2);
//        p2 = new NodeContatto(new Contatto("30", "30@cc.com"), p2);
//        p2 = new NodeContatto(new Contatto("20", "20@cc.com"), p2);
//        p2 = new NodeContatto(new Contatto("10", "10@cc.com"), p2);
//        System.out.println("Lista p2:");
//        scriviOutput(p2);

//        System.out.println("---------------------");
//        System.out.println("1. length(p) = " + length(p2));
//        System.out.println("1. length_rec(p) = " + length_rec(p2));
//        System.out.println("---------------------");
//        System.out.println("2. sum(p) = " + sum(p2));
//        System.out.println("2. sum_rec(p) = " + sum_rec(p2));
//        System.out.println("---------------------");
//        System.out.println("3. max(p) = " + max(p2));
//        System.out.println("3. max_rec(p) = " + max_rec(p2));
//        System.out.println("---------------------");
//        System.out.println("4. member(p,30) = " + member(p2, 30));
//        System.out.println("4. member(p,50) = " + member(p2, 50));
//        System.out.println("---------------------");
//        System.out.println("5. toString(q) = " + toString(q2));
//        System.out.println("5. toString(p) = " + toString(p2));
//        System.out.println("---------------------");
//        System.out.println("6. sorted(q) = " + sorted(q2));
//        System.out.println("6. sorted(p) = " + sorted(p2));
//        System.out.println("---------------------");
//        System.out.println("7. equals(p,q) = " + equals(p2, q2));
//        System.out.println("7. equals(p,p) = " + equals(p2, p2));
//        System.out.println("7. equals(q,q) = " + equals(q2, q2));
//        System.out.println("7. equals(q,p) = " + equals(q2, p2));
