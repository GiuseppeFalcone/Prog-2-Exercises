...
class Specie {
    ...
    /* Per ottenere gli attributi della classe ora e' necessario un metodo "get". Se un dato e' riservato, basta rendere il suo metodo “get” privato e l’attributo non e' piu' accessible dall’esterno della classe. */
...
public class SpecieDemo {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("terrestre: " + bufaloTerrestre);
