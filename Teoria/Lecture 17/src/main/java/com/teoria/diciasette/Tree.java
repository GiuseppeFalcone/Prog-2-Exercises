...
stringa dall’alto verso il basso, un elemento per riga, con i sottoalberi disegnati piu' a destra dell’albero di cui fan parte. Il risultato e’ un disegno bidimensionale fatto con soli caratteri ascii. */
}
// end class Tree
