package com.lab.cinque;
/*
    -Salvate tutto in un solo file Ex.
    -Completate il corpo del metodo Node rev(Node p, Node q)
        in modo che fornisca la lista p in ordine inverso seguita dalla lista q. Non modificate altro che il corpo del metodo.
...
public class Ex {
    public static Node rev(Node p, Node q) {
        /*INSERIRE CODICE QUI*/
        Node tmp = new Node(p.getElem(), p.getNext());
